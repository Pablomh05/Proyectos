...
public class NFController {
	...
	private static final byte ONLINE_ACTIVE_SERVER = 2;
	...
	public void processCommand() {
		...
		case NFCommands.COM_QUIT:
			...
			if (controllerPeer.serving()) {
				int port = controllerPeer.getServerPort(); //Lo obtengo antes de cerrar el servidor
	...
	private boolean canProcessCommandInCurrentState() {
		...
		case NFCommands.COM_SERVE: 
		case NFCommands.COM_UPLOAD: 
			if(currentState != ONLINE && currentState != ONLINE_ACTIVE_SERVER) {
				commandAllowed = false;
			}			
			break;
		case NFCommands.COM_DOWNLOAD: 
			if(currentState != ONLINE_ACTIVE_SERVER) {
				commandAllowed = false;
			}		
			break;
	...
	private void updateCurrentState(boolean success) {
		...
		case NFCommands.COM_SERVE:
			if(currentState == ONLINE) {
				currentState = ONLINE_ACTIVE_SERVER;
			}		
			break;
		default:
			break;
