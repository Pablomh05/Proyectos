...
public class PeerMessageOps {
	...
	public static final byte OPCODE_FILE_FOUND = 2;
	public static final byte OPCODE_FILE_NOT_FOUND = 3;
	public static final byte OPCODE_AMBIGUOUS_NAME = 4;
	public static final byte OPCODE_GET_CHUNK = 5;
	public static final byte OPCODE_GIVE_CHUNK = 6;
	public static final byte OPCODE_UPLOAD_FILE = 7;
	public static final byte OPCODE_CLOSE_CONNECTION = 8;
